...
class Ui_SignalSetupWidget(object):
    ...
    def retranslateUi(self, SignalSetupWidget):
        ...
        self.timeLabel.setText(QtGui.QApplication.translate("SignalSetupWidget", "time (us)", None, QtGui.QApplication.UnicodeUTF8))
